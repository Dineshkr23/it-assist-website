        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="headline text-center mb-5">
              ...
              <p className="mt-3">Comprehensive solutions for all your technology needs</p>
            </div>
          </div>
        </div>
        <div className="row">
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  ...
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-laptop" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
                  <h3 className="text-capitalize">Laptop Repair & Support</h3>
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-tv" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
                  <h3 className="text-capitalize">Desktop Computer Support</h3>
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-printer" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-shield-check" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-wifi" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
              ...
              <div className="product-list">
                <div className="product-image position-relative">
                  ...
                  <div className="service-icon-wrapper" style={{
                    ...
                    <i className="bi bi-hdd" style={{fontSize: '80px', color: '#fff', opacity: 0.9}}></i>
                  </div>
                </div>
                <div className="product-name pt-3">
          ...
          <div className="row">
            <div className="col-sm-12 up_to_off">
              <div style={{
                ...
                <div className="up_to_content" style={{
                  position: 'relative', 
                  zIndex: 2,
                  textAlign: 'center',
                  width: '100%'
                  ...
                  <h2 style={{
                    ...
                    24/7 SUPPORT - LAPTOPS, DESKTOPS, PRINTERS & MORE!
                  </h2>
                </div>
              </div>
            </div>
