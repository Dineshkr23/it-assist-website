        ...
        <div className="row">
          <div className="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div className="icon-box">
              ...
              <p>Expert repair services for all laptop and desktop brands. We handle device issues, screen replacements, battery problems, keyboard repairs, and component upgrades with precision and care.</p>
            </div>
          </div>
          <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div className="icon-box">
              ...
              <p>Complete printer services including installation, problem-solving, network setup, driver configuration, and maintenance. We support all printer brands and models for home and office use.</p>
            </div>
          </div>
          ...
          <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div className="icon-box">
              ...
              <p>Wi-Fi setup, network problem-solving, router configuration, network connection issues, and multi-device network management. Get all your devices connected seamlessly.</p>
            </div>
          </div>
        </div>
      </div>
